...
HELP_CONTENT = {
    ...
    "Multi-boot": [
        ...
        ("Menu settings",
         ...
         "menu, the move and confirm sounds (auto "
        ...
        ("Build / flash card…, and what it decides",
         ...
         "never warns that nothing was modified. After a fresh build or an "
         "update in place, no SD card holds the card yet, so Only the boot "
         "menu stays off and the whole image is written; after an Apply "
        ...
        ("The size strip and Compact build",
         ...
         "what fills the card. The sizes are walked through the BUILDER, "
