...
' $D > /home/david/evmap.txt

echo "total registrations: $(wc -l < /home/david/evmap.txt)"
echo
echo "=== event 93 (0x5d) ==="
grep -E '^event  93' /home/david/evmap.txt
echo "=== event 94 (0x5e) ==="
grep -E '^event  94' /home/david/evmap.txt
echo
echo "=== distinct event ids seen ==="
awk '{print $2}' /home/david/evmap.txt | sort -n | uniq -c | tr '\n' ' ' | head -c 3000
echo
