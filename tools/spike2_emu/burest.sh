...
for kv in "PAD_SW_REST=1" "PAD_SW_REST=0"; do
  ...
  bash /mnt/c/Users/david/Documents/development/pinball-asset-decryptor/tools/spike2_emu/nbrun.sh "$L" 115 "$kv" \
  ...
  cp -f /home/david/shots/*.png "/home/david/$L.frames" 2>/dev/null || true
