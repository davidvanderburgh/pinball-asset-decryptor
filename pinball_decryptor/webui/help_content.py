...
HELP_CONTENT = {
    ...
    "Replace Audio": [
        ...
        ("Longer replacements (Advanced Audio Options)",
         ...
         "and a stock 8 GB card can have only a few hundred MB free. SD card "
         "size on the Write tab builds for a bigger SD card and gives the "
         "games partition that room, but it does not raise the 2 GB limit. "
         "Running out of room on the games partition is not trimmed: the "
         "build stops and says how much room it needs."),
    ],
    "Replace Video": [
        ("Scan and assign",
        ...
        ("Size limits",
         ...
         "out; SD card size on the Write tab builds for a bigger SD card and "
         "gives the games partition that room. A clip is squeezed to fit its "
         "slot's byte size only on a direct SD write, or when this computer "
         "can't write whole files to the card (on Windows that needs "
         "WSL2)."),
        ...
        ("Checking a card you already built",
         ...
         "for a bigger SD card with SD card size on the Write tab. A clip "
         "that is just low in bitrate "
    ...
    "Write": [
        ...
        ("SD card size (Stern Spike 2)",
         ...
         "is encoded, a build adds up what it will put on the games "
         "partition, and one that won't fit is refused then, with the "
         "numbers and the SD card size that would fit (when one would), "
         "instead of failing at the end. Only sizes bigger than the "
