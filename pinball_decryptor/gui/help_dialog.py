...
HELP_CONTENT = {
    ...
    "Emulate": [
        ...
        ("Save states (opt in)",
         ...
         "roughly 50–150 MB on the WSL disk (snapshots compress about "
         "twentyfold; a save briefly needs ~1.5 GB free while it packs), "
         "and each save freezes the game and its sound for a few seconds "
         "while the snapshot is written. "
         "The list on the tab shows the slots for the card you have picked "
         "— a save from one game can never load into another, so other "
         "games' slots are counted under the list rather than shown (pick "
         "that game's card and they appear; no card picked shows "
