...
HELP_CONTENT = {
    ...
    "Emulate": [
        ...
        ("Save states",
         ...
         "They also need one package inside WSL that nothing else here "
         ...
         "game's, and that takes a native static program. Without it every "
         ...
         "Start, and “Set up emulator…” installs the package."),
        ...
        ("Set up emulator… (Windows only)",
         ...
         "One package is listed apart from those, under “Save states need:”, "
         "because its absence costs a feature and not the emulator: without "
         "busybox-static every title still starts and runs and only the save "
         ...
         "running an emulator it runs perfectly well. The button installs it "
         "along with the rest, and a Linux desktop is never asked for it at "
         "all, since the freezable boot shape is a Windows one. "
