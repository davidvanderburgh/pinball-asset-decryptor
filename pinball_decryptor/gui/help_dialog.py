...
HELP_CONTENT = {
    ...
    "Multi-boot": [
        ...
        ("The tab, top to bottom",
         ...
         "Then one bar: Menu settings… on the left, and on the right ONE "
         "green button, Build / flash card…, beside Run in emulator. "
        ...
        ("The card path, and the three buttons beside it",
         ...
         "card… reads the boot menu straight off the card in the reader — "
         "titles, pictures, sounds, settings and where the images came "
         "from — without its image file: only the menu's part of the card "
         "is read, so the games' versions are not shown, and Build / flash "
         "card… then writes the menu back onto that card. The checks above "
        ...
        ("The size strip and Compact build",
         ...
         "what fills the card. Compact build (off by default) stores every "
