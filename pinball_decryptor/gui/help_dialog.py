...
HELP_CONTENT = {
    ...
    "Multi-boot": [
        ...
        ("Menu settings",
         ...
         "generates tones, and under those words every sound box — here "
         "and in Edit image… — lists the WAV files this menu already "
         "uses, so the same clip goes on every image without browsing for "
         "it again), the volume, the countdown (0 = wait for "
