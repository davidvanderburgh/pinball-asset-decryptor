...
HEADER = (
    ...
    "# of the game program on Write (needs an image build); 'unused' = no\n"
    "# reference to the line was found in the game program.\n"
    "# asset_path\toriginal\treplacement\tmax_bytes\tflags\n")

#: 5th-column flag tokens (space-separated; unknown tokens are ignored, and a
#: manifest without the column loads with neither flag set).
FLAG_GROWS = "grows"
FLAG_UNUSED = "unused"
