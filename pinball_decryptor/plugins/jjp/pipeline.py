    ...
    def run(self):
        ...
        try:
            ...
            if self._is_iso() and hasattr(self, '_output_iso_path'):
                ...
                if sys.platform == "win32":
                    self.log(
                        "1. Make the install stick: \"Build / make USB\n"
                        "   install stick…\" on the Write tab formats a\n"
                        "   stick and copies this ISO's files onto it.\n"
                        "   By hand instead: Rufus, default settings, 'ISO\n"
                        "   Image mode' when it asks. Do NOT use balenaEtcher\n"
                    ...
                    self.log(
                        ...
                        "   install stick…\" on the Write tab formats a\n"
                        "   stick and copies this ISO's files onto it.\n"
                        "   By hand instead: format a stick FAT32 with an\n"
                        "   MBR scheme (Disk Utility: MS-DOS (FAT) + MBR),\n"
                        "   then mount this ISO and copy ALL of its files\n"
                        "   onto the stick. Do NOT raw-write the ISO with\n"
