...
5. **Replace Audio tab** *(file-based plugins)* — swap a game's music /
   ...
   **Rename…** corrects a slot's name in place; the name is remembered
   ...
   menu the sound effects arrive **already named by the game itself**
   ...
   yourself. Tick **Play through the list** and a clip that finishes
