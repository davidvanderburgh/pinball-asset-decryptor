...
def _media_row(parent, row, col, label, var, choices, filetypes,
               label_w=13, combo_w=26, on_play=None, theme_fn=None):
    ...
    def __init__(self, panel, index, row):
        ...
        ttk.Label(snd, foreground=th["gray"], wraplength=560,
                  ...
                  text="Music loops while this image is highlighted. The "
                       ...
                       "menu = whatever the whole menu uses. " + PLAY_NAME
...
class MenuSettingsDialog(_Modal):
    ...
    def __init__(self, panel, images):
        ...
        _media_row(g, 0, 0, "Move sound:", panel._move_var, SOUND_CHOICES,
                   [("WAV audio", "*.wav")], label_w=15,
                   on_play=panel.play_sound_choice, theme_fn=panel._theme_fn)
