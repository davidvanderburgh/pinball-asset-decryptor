...
PAD_SELECT_SRCS="codeselect/codeselect.c codeselect/conf.c codeselect/conf.h codeselect/theme.c codeselect/theme.h codeselect/themes.json codeselect/gen_themes.py codeselect/gfx.c codeselect/gfx.h codeselect/egl_stern.c codeselect/egl_stern.h codeselect/input.c codeselect/input.h codeselect/input_hw.c codeselect/input_padsw.c codeselect/input_jjpio.c codeselect/egl_x11.c codeselect/stubs_jjp.c codeselect/audio_pulse.c codeselect/jjp_glibc.h codeselect/padselect.sh codeselect/log.c codeselect/log.h codeselect/art.c codeselect/art.h codeselect/audio.c codeselect/audio.h codeselect/audio_fifo.c codeselect/audio_alsa.c codeselect/codec.c codeselect/codec.h codeselect/nvm.c codeselect/nvm.h codeselect/Makefile codeselect/select.sh codeselect/materialize.py codeselect/images.conf.example codeselect/third_party/stb_truetype.h codeselect/third_party/stb_image.h"
