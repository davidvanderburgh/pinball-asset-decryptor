...
cost a few GB rather than forty copies of the sound library. From v0.209.0 the line across the top of the menu is yours to write, or to leave off altogether; every sound in the tab has a **Play** button that plays it here, on the spot; and a compact card that cannot be laid out names the SD card size the content wants instead of saying a check failed:
