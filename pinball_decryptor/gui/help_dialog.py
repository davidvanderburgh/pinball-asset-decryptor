...
HELP_CONTENT = {
    ...
    "Mod Pack": [
        ...
        ("Transfer mods",
         ...
         "be matched is reported instead of silently dropped. Your staged "
    ...
    "Emulate": [
        ...
        ("Check setup…",
         ...
         "available, which display it has, and a last line saying whether "
         "this PC can run the emulator. That is the paste to send when a run "
         "goes wrong. The amber notice above only speaks when something is "
