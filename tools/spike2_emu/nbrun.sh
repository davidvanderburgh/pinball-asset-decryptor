...
mkdir -p /home/david/shots
rm -f /home/david/shots/*.png
...
bash /mnt/c/Users/david/Documents/development/pinball-asset-decryptor/tools/spike2_emu/runbridge.sh "$LOG" "$SECS" gpu
...
echo "--- frames ---"
ls -l /home/david/shots/*.png 2>/dev/null | tail -5
