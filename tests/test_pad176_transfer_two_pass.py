...
def test_declining_both_carries_only_the_folder_s_own_and_says_so(monkeypatch,
                                                                 _built):
    me = _fake_app(stock_dir="stock")
...
def test_a_folder_off_a_stock_card_is_untouched(monkeypatch):
    """No baked mods, no question, no warning: the long-standing behaviour."""
